...
RETRY_DELAY = 6
MAX_RETRIES = 3
QUERY_RADIUS_M = 20 # Radius um den repräsentativen Punkt
...
HIGHWAY_QUERY_FILTER = "|".join(RELEVANT_HIGHWAY_TYPES)
...
def fetch_surface_grouped(track_loc_csv: str, output_csv_path: str, query_radius: int):
    ...
    for point_info in tqdm(representative_points, desc="Querying Surface Data"):
        ...
        ( way(around:{query_radius},{lat:.7f},{lon:.7f})[{'"highway"~"{HIGHWAY_QUERY_FILTER}"'}]; );
