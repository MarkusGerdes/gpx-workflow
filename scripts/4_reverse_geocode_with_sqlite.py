...
# -*- coding: utf-8 -*-
"""
4_reverse_geocode_with_sqlite.py
--------------------------------
Reverse geocoding with SQLite caching for improved performance.
Uses Nominatim API with intelligent caching and sampling strategies.
"""

# === SCRIPT METADATA ===
SCRIPT_NAME = "4_reverse_geocode_with_sqlite.py"
SCRIPT_VERSION = "2.1.0"
SCRIPT_DESCRIPTION = "SQLite-cached reverse geocoding with Nominatim API integration"
...
v2.1.0 (2025-06-07): Standardized header, improved metadata tracking and error handling
"""

# === SCRIPT CONFIGURATION ===
DEFAULT_CONFIG_SECTION = "reverse_geocoding"
INPUT_FILE_PATTERN = "*_track_simplified.csv"
OUTPUT_FILE_PATTERN = "*_geocoded.csv"
...
# Import des SQLite Cache Systems
from sqlite_geocoding_cache import SQLiteGeocodingCache, GeocodingResult
    ...
    for idx, row in tqdm(df.iterrows(), total=len(df), desc="Geokodierung", unit="Punkt"):
        ...
        if do_geocode:
            ...
            if cached_result:
                ...
                # Cache-Eintrag in DB für diesen Track-Point referenzieren
                geocoding_cache_id = cache.cache_geocoding_result(cached_result)
