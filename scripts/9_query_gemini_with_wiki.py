...
Bitte gib als Antwort nur Markdown zurück, formatiere Schlüsselwörter fett und beachte folgendes Format:
...
Sprich sportliche Leser manchmal direkt an, sei motivierend und gern mit einem Augenzwinkern.
