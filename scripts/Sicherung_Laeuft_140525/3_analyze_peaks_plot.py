...
def plot_profile(base_filename: str,
    ...
    ncol = 6 if num_legend_items > 12 else 5 if num_legend_items > 9 else 4 # Angepasste Spalten
    ...
    fig.tight_layout(rect=[0, 0.08, 1, 0.96]) # Platz für Legende lassen
...
def main(args):
    ...
    plot_profile(base_filename, plot_df_for_plot,
                 ...
                 config,
                 args.output_plot,
                 places_coords_df) # Übergebe Ortsdaten
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Analyze GPX track data, find peaks, calculate stats, generate plots, and optionally annotate with places.")
